...
class TestTools(unittest.TestCase):
    def test_conflicting_passes(self):
        ...
        self.assertEquals(len(conflicting_passes(passes, timedelta(seconds=0))), 2)
        self.assertEquals(len(conflicting_passes(passes, timedelta(seconds=60))), 1)
...
class TestBoundary(unittest.TestCase):
    def test_contour(self):
        ...
        bond = Boundary((side1_lons, side1_lats),
...
def suite():
    ...
    mysuite.addTest(loader.loadTestsFromTestCase(TestBoundary))
